 ...
 */
export function mediaPayload(url: string, mimeType: string, title?: string): MediaAddItem {
 ...
 */
export function inferMediaMimeType(filePath: string): MediaMimeType | undefined {
 ...
 */
export function resolveUnderAllowed(value: string, allowedRoots: readonly string[]): string {
